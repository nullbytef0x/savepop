...
export async function handleHlsPlaylist(streamInfo, req, res) {
    ...
    // Some CDNs (notably Bluesky's) label playlists as generic binary data.
    // FFmpeg consumes these through extensionless internal tunnel URLs, so it
    // needs the correct MIME type to recognize the rewritten HLS playlist.

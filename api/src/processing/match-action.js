...
export default function({
    ...
    if (!params.isHLS && responseType !== "picker") {
        // Some services provide fragmented DASH tracks that native FFmpeg can
        // merge, but the browser LibAV probe cannot reliably identify. Keep
        ...
        if (!browserProcessingUnsupported && (localProcessing === "forced" || isPreferredWithExtra)) {
